...
namespace HackathonApplitools.PageObjects
{
    public class ProductDetailPageObject
    {
        ...
        public const string QuickLinksListCssSelector = "footer div:has(h3:contains({0}))>div>ul>li>a";
        ...
        public const string KeepInTouchCssSelector = "h3:contins(Keep in touch)";
