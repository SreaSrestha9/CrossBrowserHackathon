...
namespace HackathonApplitools.PageObjects
{
    public class HomePageObjects
    {
        ...
        public const string AccountWishlistCartCssTemplate = "a:has(span:contains({0}))";
        #endregion
        ...
        public const string SideFilterButtonCssTemplate = "div.buttons>button:contains({0})";
        ...
        public const string ProductDetailLinkByImageCssTemplate = "div#product_grid>div>div >figure#{0}>a";
